...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { district_id: @sector.district_id, name: @sector.name } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { district_id: @sector.district_id, name: @sector.name } }
